...
function auditable(target: object, key: string | symbol) {
    // save initial value of the property, before decorator is applied
    let val = target[key]

    // then overwrite the property w/ custom getter and setter
...
class ContactRepository {
    @auditable // property decorator to Contact's property
